...
if __name__ == "__main__":
    ...
    print("Example String : Hello,World,Hello,Philippines")
    print("Concatenated string with spaces:", concatenate_with_spaces("Hello", "world", "Hello", "Philippines"))
    print("")
    ...
    print(name_and_age_paragraph("Rochelle", 21))